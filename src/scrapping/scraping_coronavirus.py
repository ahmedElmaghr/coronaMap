...
for tr in countries:
    ...
    l.append(row)
df = pd.DataFrame(l, columns=["#","Country", "TotalCases", "NewCases", "TotalDeaths","NewDeaths","TotalRecovered","ActiveCases","Serious,Critical","Cases/1M pop","Death1m","TotalTest","Test1MPeople","temp","population"])
